...
iv_keyword = "layer"
dv_keyword = "corr"
color <- c( "#FFB987","#FDAB95","#FA9DA3","#F88EB0","#F680BE","#F372CC","#F164DA","#EE55E7","#EC47F5")
...
subjectwise$layer_ordered <- factor(
  ...
  levels = c(    "layer3.0", "layer3.1", "layer3.2", "layer3.3", "layer3.4", "layer3.5", "layer4.0", "layer4.1", "layer4.2"
  )
)
subjectwise$varint <-
...
subjectwise$layer_ordered <- factor(
  subjectwise$layer_ordered,
  levels = c(
    "layer3.0", "layer3.1", "layer3.2", "layer3.3", "layer3.4", "layer3.5", "layer4.0", "layer4.1", "layer4.2"
  )
)
subjectwise$varint <-
  as.factor(paste(subjectwise$layer_ordered, subjectwise$func))
...
contrasts(average_fisherz$layer_con) = contr.helmert(9)
...
int_color = c("#FFB987","#FFA276","#FF8B65","#FF7454","#FF5D44","#FF4533","#FF2E22","#FF1711","#FF0000",
        "#FFB987","#E9A296","#D28BA4","#BC74B3","#A65DC2","#8F45D0","#792EDF","#6217ED","#4C00FC"
)
