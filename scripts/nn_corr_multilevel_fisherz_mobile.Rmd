...
concat_df = data.frame()
  for (dv in c('mobilenet_ablation_impact_X_cka', 
               'mobilenet_ablation_impact_X_mean_cca_corr', 
               'mobilenet_ablation_impact_X_mean_sq_cca_corr',
               'mobilenet_ablation_impact_X_procrustes', 
               'mobilenet_ablation_impact_X_pwcca',
               'mobilenet_decoding_accuracy_delta_X_cka',
               'mobilenet_decoding_accuracy_delta_X_mean_cca_corr',
               'mobilenet_decoding_accuracy_delta_X_mean_sq_cca_corr',
               'mobilenet_decoding_accuracy_delta_X_procrustes', 
               'mobilenet_decoding_accuracy_delta_X_pwcca')) {
  if (model == "alexnet") {
