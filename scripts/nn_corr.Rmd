...
for (model in c('alexnet', 'mobilenet')) {
  ...
  statsummary <- ""
  for (dv in c('ablation_impact_X_cka', 'ablation_impact_X_decoding_accuracy_delta',
               'ablation_impact_X_mean_cca_corr', 'ablation_impact_X_mean_sq_cca_corr',
               'ablation_impact_X_procrustes', 'ablation_impact_X_pwcca',
               'decoding_accuracy_delta_X_mean_cca_corr', 'decoding_accuracy_delta_X_mean_sq_cca_corr',
               'decoding_accuracy_delta_X_procrustes', 'decoding_accuracy_delta_X_pwcca')) {
